...
class CreationError(ValueError):
    """An invalid attempt to create WS template/project was detected."""
...
class NarrativeGenerateError(Exception):
    ...
    def __init__(self, response, data):
        ...
        self.msg = '\nError generating narrative.' + \
                   ...
                   '\nNumber of errors reported by Wordsmith: {}'.format(
                       len(self.details) if self._details_reported else 0)
